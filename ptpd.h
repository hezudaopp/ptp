...
/*CHANGE add driver header and headers used to make ioctl works*/
#include "dp83640.h" /*same definition of structures have been removed*/
/*CHANGE ENDS*/

//CHANGE add 802.3 header
...
void timeInternal_readable(TimeInternal * timeInternal, char * msgType);
void timestamp_display(Timestamp*);
