...
void msgUnpackSync(void*,MsgSync*,TimeInternal*);
...
void msgPackFlag(void*, PtpClock*);
...
void msgDisplayBuf(void *buf,UInteger8 len);
...
ssize_t macRecvEvent(Octet*,TimeInternal*,NetPath*);
ssize_t macRecvGeneral(Octet*,TimeInternal*,NetPath*);
//CHANGE ENDS
...
//CHANGE add mac version
ssize_t macSendEvent(Octet*,UInteger16,NetPath*);
ssize_t macSendGeneral(Octet*,UInteger16,NetPath*);
ssize_t macSendPeerGeneral(Octet*,UInteger16,NetPath*);
ssize_t macSendPeerEvent(Octet*,UInteger16,NetPath*);
/** \}*/
 ...
 * -Handle with runtime options*/
 /**\{*/
int logToFile(void);
int time2log(TimeInternal * timeInternal);
...
void setDriverTime(TimeInternal*);
void adjDriverTime(TimeInternal*);
void adjDriverRate( PtpClock * ptpClock);
void readDriverTime(TimeInternal*);
void readCacheTime(TimeInternal*,int);
void tmpAdjDriverFreq(TmpRate* tmpRate);
void rectifyInsertedTimestamp(TimeInternal *osTime, TimeInternal *timestamp);
double getRand(void);
